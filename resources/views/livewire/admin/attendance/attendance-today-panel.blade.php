<aside class="dashboard-hero__panel dashboard-reveal" style="--reveal-delay: 120ms" wire:poll.10s.visible>
    ...
    @if ($onLeave)
        <div class="att-panel__on-leave">
            <p class="att-panel__on-leave-title">You are on leave</p>
            <p class="att-panel__on-leave-text">That’s why no shift start is needed today.</p>
        </div>
    @else
        @if ($successMessage)
            <p
